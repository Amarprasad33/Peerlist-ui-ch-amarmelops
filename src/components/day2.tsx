            ...
            <div
                ...
                <AnimatePresence mode="wait">
                    <motion.div className='flex gap-1'>
                        {/* {icons[status]} */}
                        {status === STATUS.ANALYZING && <div role="status" className='z-20'>
                        ...
                        {status === STATUS.SAFE && <svg className='mt-[3px]' width="18" height="18" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
